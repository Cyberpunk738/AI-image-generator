...
const API_KEY = "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"; //Hugging face API key
...
const updateImageCard = (imgIndex, imgUrl) => {
    ...
    // Replacing Spinners with actual image
...
const generateImages = async (selectedModel, imageCount, aspectRatio, promptText) => {
    ...
    // create an array in form of image generation promises
...
// Create placeholders card with loading spinners
